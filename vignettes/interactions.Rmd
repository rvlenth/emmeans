...
<!-- @index Vignettes!Interactions; Interaction analysis -->
...
<!-- @index Examples!`auto.noise`; Interactions!Possible nappropriateness of marginal means 
  Interaction plots; `emmip()` -->
...
<!-- @index Simple contrasts; `contrast()`!`simple`; `contrast()`!`combine` -->
...
<!-- @index Interaction contrasts; `contrast()`!`interaction` 
...
<!-- @index Interactions!Covariate with factors; Examples!`oranges` -->
