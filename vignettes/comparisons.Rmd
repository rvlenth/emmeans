...
<!-- @index Dunnett method; `pairwise`; `revpairwise`; `trt.vs.ctrl`;
            `eff`; `consec` -->
...
<!-- @index Contrasts!Custom; `.emmc` functions@emmc; `adjust` -->
...
```
<!-- @index Contrasts!Tests!with transformations@trans -->
