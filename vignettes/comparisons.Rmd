...
These may be generated by the `CLD()` function.
I really recommend against this method, though, and decline to illustrate it.
...
is now deprecated and will be removed entirely from **emmeans** at a future date.
