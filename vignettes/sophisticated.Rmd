...
<!-- @index `lmerMod` models; Examples!`nlme::Oats`; Examples!Split-plot experiment -->
...
<!-- @index `lmerMod` objects!System options for -->
...
<!-- @index Ordinal models; Examples!`ordinal::wine`; Examples!Ordinal model
...
<!-- @index Bayesian models; Examples!Bayesian model; Examples!`lme4::cbpp`
    `rstanarm` -->
