...
<!-- @index `summary()`; `infer`; `confint()`; `test()`; Confidence intervals;
...
## "By" variables {#byvars}
<!-- @index `by` variables; Grouping into separate sets -->
...
<!-- @index `joint_tests()`; Type III ANOVA; Analysis of variance!Type III -->
```{r}
