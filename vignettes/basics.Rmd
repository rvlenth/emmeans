...
```{r fig.alt = "interaction-style plots of 'RG4' and 'RG5'. These show parallel trends along 'percent' for each 'source'. The one for 'RG5' consists of parallel straight lines. The values plotted here can be obtained via 'summary(RG4)' and 'summary(RG5)'"}
