...
<!-- @index Reference grid!Altering; `ref_grid()`!`cov.reduce`; 
...
<!-- @index Graphical displays; Plots!of EMMs@emms; Plots!Interaction-style 
            `emmip()`;  `plot.emmGrid()`; **ggplot2** package
            Plots!of confidence intervals@conf -->
...
<!-- @index Multivariate models; Examples!`MOats`; `ref_grid()`!`mult.name` -->
