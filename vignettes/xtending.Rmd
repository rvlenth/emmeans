...
```
This only has an effect if the user has the **emmeans** package installed (in which case **estimability** is also imported by **emmeans**); otherwise the code is skipped. We need to import the prototypes for `recover_data` and `emm_basis`, and register our new methods.
