...
#' types of models are supported by the package. See \code{help("models", package
#' = "emmeans")} for full details. Some models require other packages be
#' installed in order to  obtain all the available features.}
#' 
