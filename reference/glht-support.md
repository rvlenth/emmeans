...
#> L - M == 0  20.5556     5.1573   3.986 0.000706 ***
#> L - H == 0  20.0000     5.1573   3.878 0.000887 ***
#> M - H == 0  -0.5556     5.1573  -0.108 0.993625    
#> ---
...
#> ., L - M == 0  20.5556     5.1573   3.986  0.00117 ** 
#> ., L - H == 0  20.0000     5.1573   3.878  0.00149 ** 
...
#> Linear Hypotheses:
#>            Estimate Std. Error t value Pr(>|t|)    
#> L - M == 0  20.5556     5.1573   3.986 0.000603 ***
#> L - H == 0  20.0000     5.1573   3.878 0.000900 ***
#> M - H == 0  -0.5556     5.1573  -0.108 0.993623    
#> ---
#> Signif. codes:  0 ‘***’ 0.001 ‘**’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1
#> (Adjusted p values reported -- single-step method)
#> 
...
#> L - H, A == 0  20.0000     5.1573   3.878  0.00189 **
#> M - H, A == 0  -0.5556     5.1573  -0.108  0.99996   
#> L - M, B == 0  -0.5556     5.1573  -0.108  0.99996   
#> L - H, B == 0   9.4444     5.1573   1.831  0.30797   
